  ...
  return (
    <section id="depoimentos" className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        >
          {/* HIERARQUIA 1: Título Principal da Seção (h2) */}
            ...
            >
              ...
              <div className="flex items-center mb-6 mt-4">
                <img
                  ...
                  // ✅ CORREÇÃO CLS: Adicionado width e height (w-16 h-16 = 64px)
                  width={64} 
                  height={64}
                  // ✅ CORREÇÃO Performance: Carregamento preguiçoso (abaixo da dobra)
                  loading="lazy"
                />
                
                <div>
                  {/* ✅ CORREÇÃO A11y: Trocado <h4> para <p> para manter a hierarquia H2 -> H3 */}
              ...
              <div className="flex mb-4">
                {[...Array(testimonial.rating)].map((_, i) => (
                  // ✅ CORREÇÃO A11y: Ícones decorativos
        ...
        >
          <div className="bg-gradient-to-r from-indigo-500 to-purple-600 rounded-2xl p-8 text-white">
            {/* HIERARQUIA 2: Sub-seção de Resultados (h3 está correto abaixo do h2) */}
